...
import { ROUTINES, PROGRAMS, EQUIPMENTS } from './constants';
import { generateCustomRoutine, createChatSession, generateAiImage, editAiImage } from './services/gemini';
import { Difficulty, Routine, Program } from './types';
